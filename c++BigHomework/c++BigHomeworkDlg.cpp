...
// CcBigHomeworkDlg 消息处理程序

BOOL CcBigHomeworkDlg::OnInitDialog()
{
...
void CcBigHomeworkDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//显示。
HCURSOR CcBigHomeworkDlg::OnQueryDragIcon()
{
